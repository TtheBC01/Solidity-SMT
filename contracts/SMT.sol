...
contract SMT {
    ...
    function addLeaf(string memory _leaf) external {
    ...
    function _insert(bytes32 _leaf) internal returns (uint32 index) {
        ...
        for (uint32 i = 0; i < levels; i++) {
            ...
            currentLevelHash = Hashes.commutativeKeccak256(left, right);
            currentIndex /= 2;
        }
    ...
    /// @dev provides Zero (Empty) elements for a keccak256 MerkleTree. Up to 32 levels
